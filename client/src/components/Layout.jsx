  ...
  return (
    <div className="min-h-screen w-full bg-cream">
      <div className="flex min-h-screen w-full flex-col px-4 pb-10 pt-4 sm:px-6 md:px-10 lg:px-14 xl:px-20">
        <header className="mb-6 flex w-full items-center gap-3 border-b border-navy/10 pb-5 sm:mb-8">
          <Link to="/" className="flex items-center gap-3">
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-navy text-lg font-black text-gold sm:h-11 sm:w-11">
              S
            </span>
        ...
        <footer className="mt-10 w-full border-t border-navy/10 pt-5 text-left">
